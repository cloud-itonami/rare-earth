...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23195){
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23214){
var vec__23215 = p__23214;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23215,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23215,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23242){
var vec__23243 = p__23242;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23243,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23243,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__23262(s__23263){
return (new cljs.core.LazySeq(null,(function (){
var s__23263__$1 = s__23263;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23263__$1);
if(temp__5825__auto__){
var s__23263__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23263__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23263__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23265 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23264 = (0);
while(true){
if((i__23264 < size__5479__auto__)){
var vec__23270 = cljs.core._nth(c__5478__auto__,i__23264);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23270,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23270,(1),null);
cljs.core.chunk_append(b__23265,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__23468 = (i__23264 + (1));
i__23264 = G__23468;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23265),shitsuke$hig$pair__GT_css_$_iter__23262(cljs.core.chunk_rest(s__23263__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23265),null);
}
} else {
var vec__23286 = cljs.core.first(s__23263__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23286,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23286,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__23262(cljs.core.rest(s__23263__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__23318(s__23319){
return (new cljs.core.LazySeq(null,(function (){
var s__23319__$1 = s__23319;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23319__$1);
if(temp__5825__auto__){
var s__23319__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23319__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23319__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23321 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23320 = (0);
while(true){
if((i__23320 < size__5479__auto__)){
var vec__23322 = cljs.core._nth(c__5478__auto__,i__23320);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23322,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23322,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__23321,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__23320,s__23319__$1,vec__23322,group,m,c__5478__auto__,size__5479__auto__,b__23321,s__23319__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23318_$_iter__23328(s__23329){
return (new cljs.core.LazySeq(null,((function (i__23320,s__23319__$1,vec__23322,group,m,c__5478__auto__,size__5479__auto__,b__23321,s__23319__$2,temp__5825__auto__){
return (function (){
var s__23329__$1 = s__23329;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23329__$1);
if(temp__5825__auto____$1){
var s__23329__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__23329__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__23329__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__23331 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__23330 = (0);
while(true){
if((i__23330 < size__5479__auto____$1)){
var vec__23332 = cljs.core._nth(c__5478__auto____$1,i__23330);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23332,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23332,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__23331,shitsuke.hig.pair__GT_css(group,k,v));

var G__23471 = (i__23330 + (1));
i__23330 = G__23471;
continue;
} else {
var G__23472 = (i__23330 + (1));
i__23330 = G__23472;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23331),shitsuke$hig$tokens__GT_css_lines_$_iter__23318_$_iter__23328(cljs.core.chunk_rest(s__23329__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23331),null);
}
} else {
var vec__23339 = cljs.core.first(s__23329__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23318_$_iter__23328(cljs.core.rest(s__23329__$2)));
} else {
var G__23473 = cljs.core.rest(s__23329__$2);
s__23329__$1 = G__23473;
continue;
}
}
} else {
...
});})(i__23320,s__23319__$1,vec__23322,group,m,c__5478__auto__,size__5479__auto__,b__23321,s__23319__$2,temp__5825__auto__))
,null,null));
});})(i__23320,s__23319__$1,vec__23322,group,m,c__5478__auto__,size__5479__auto__,b__23321,s__23319__$2,temp__5825__auto__))
;
...
var G__23474 = (i__23320 + (1));
i__23320 = G__23474;
continue;
} else {
var G__23475 = (i__23320 + (1));
i__23320 = G__23475;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23321),shitsuke$hig$tokens__GT_css_lines_$_iter__23318(cljs.core.chunk_rest(s__23319__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23321),null);
}
} else {
var vec__23349 = cljs.core.first(s__23319__$2);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23349,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23349,(1),null);
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__23319__$1,vec__23349,group,m,s__23319__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23318_$_iter__23352(s__23353){
return (new cljs.core.LazySeq(null,((function (s__23319__$1,vec__23349,group,m,s__23319__$2,temp__5825__auto__){
return (function (){
var s__23353__$1 = s__23353;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23353__$1);
if(temp__5825__auto____$1){
var s__23353__$2 = temp__5825__auto____$1;
...
var vec__23359 = cljs.core._nth(c__5478__auto__,i__23354);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23359,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23359,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__23355,shitsuke.hig.pair__GT_css(group,k,v));

var G__23476 = (i__23354 + (1));
i__23354 = G__23476;
continue;
} else {
var G__23477 = (i__23354 + (1));
i__23354 = G__23477;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23355),shitsuke$hig$tokens__GT_css_lines_$_iter__23318_$_iter__23352(cljs.core.chunk_rest(s__23353__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23355),null);
}
} else {
var vec__23365 = cljs.core.first(s__23353__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23318_$_iter__23352(cljs.core.rest(s__23353__$2)));
} else {
var G__23480 = cljs.core.rest(s__23353__$2);
s__23353__$1 = G__23480;
continue;
}
}
} else {
...
});})(s__23319__$1,vec__23349,group,m,s__23319__$2,temp__5825__auto__))
,null,null));
});})(s__23319__$1,vec__23349,group,m,s__23319__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__23318(cljs.core.rest(s__23319__$2)));
} else {
var G__23481 = cljs.core.rest(s__23319__$2);
s__23319__$1 = G__23481;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__23420(s__23421){
return (new cljs.core.LazySeq(null,(function (){
var s__23421__$1 = s__23421;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23421__$1);
if(temp__5825__auto__){
var s__23421__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23421__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23421__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23423 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23422 = (0);
while(true){
if((i__23422 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__23422);
cljs.core.chunk_append(b__23423,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__23531 = (i__23422 + (1));
i__23422 = G__23531;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23423),shitsuke$hig$iter__23420(cljs.core.chunk_rest(s__23421__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23423),null);
}
} else {
var style = cljs.core.first(s__23421__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__23420(cljs.core.rest(s__23421__$2)));
}
} else {
return null;
}
