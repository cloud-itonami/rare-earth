...
return [":root { ",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",(function (){var iter__5480__auto__ = (function byoubu_ui$tokens$iter__23150(s__23151){
return (new cljs.core.LazySeq(null,(function (){
var s__23151__$1 = s__23151;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23151__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__23156 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23156,(0),null);
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23156,(1),null);
var iterys__5476__auto__ = ((function (s__23151__$1,vec__23156,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function byoubu_ui$tokens$iter__23150_$_iter__23152(s__23153){
return (new cljs.core.LazySeq(null,((function (s__23151__$1,vec__23156,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
...
var vec__23159 = cljs.core._nth(c__5478__auto__,i__23154);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23159,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23159,(1),null);
cljs.core.chunk_append(b__23155,[byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''));

var G__23169 = (i__23154 + (1));
i__23154 = G__23169;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23155),byoubu_ui$tokens$iter__23150_$_iter__23152(cljs.core.chunk_rest(s__23153__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23155),null);
}
} else {
var vec__23162 = cljs.core.first(s__23153__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23162,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23162,(1),null);
return cljs.core.cons([byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''),byoubu_ui$tokens$iter__23150_$_iter__23152(cljs.core.rest(s__23153__$2)));
}
} else {
return null;
}
...
});})(s__23151__$1,vec__23156,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__23151__$1,vec__23156,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
;
...
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,byoubu_ui$tokens$iter__23150(cljs.core.rest(s__23151__$1)));
} else {
var G__23171 = cljs.core.rest(s__23151__$1);
s__23151__$1 = G__23171;
continue;
}
} else {
return null;
