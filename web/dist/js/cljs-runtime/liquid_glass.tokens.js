...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__22173){
var map__22174 = p__22173;
var map__22174__$1 = cljs.core.__destructure_map(map__22174);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22174__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22174__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22174__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__22182(s__22183){
return (new cljs.core.LazySeq(null,(function (){
var s__22183__$1 = s__22183;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22183__$1);
if(temp__5825__auto__){
var s__22183__$2 = temp__5825__auto__;
...
var i = cljs.core._nth(c__5478__auto__,i__22184);
cljs.core.chunk_append(b__22185,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22292 = (i__22184 + (1));
i__22184 = G__22292;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22185),liquid_glass$tokens$iter__22182(cljs.core.chunk_rest(s__22183__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22185),null);
}
} else {
var i = cljs.core.first(s__22183__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__22182(cljs.core.rest(s__22183__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__22188(s__22189){
return (new cljs.core.LazySeq(null,(function (){
var s__22189__$1 = s__22189;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22189__$1);
if(temp__5825__auto__){
var s__22189__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22189__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22189__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22191 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22190 = (0);
while(true){
if((i__22190 < size__5479__auto__)){
var vec__22192 = cljs.core._nth(c__5478__auto__,i__22190);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22192,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22192,(1),null);
cljs.core.chunk_append(b__22191,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22306 = (i__22190 + (1));
i__22190 = G__22306;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22191),liquid_glass$tokens$pair__GT_css_$_iter__22188(cljs.core.chunk_rest(s__22189__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22191),null);
}
} else {
var vec__22195 = cljs.core.first(s__22189__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22195,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22195,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__22188(cljs.core.rest(s__22189__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22198(s__22199){
return (new cljs.core.LazySeq(null,(function (){
var s__22199__$1 = s__22199;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22199__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__22204 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22204,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22204,(1),null);
var iterys__5476__auto__ = ((function (s__22199__$1,vec__22204,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22198_$_iter__22200(s__22201){
return (new cljs.core.LazySeq(null,((function (s__22199__$1,vec__22204,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22201__$1 = s__22201;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22201__$1);
if(temp__5825__auto____$1){
var s__22201__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22201__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22201__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22203 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22202 = (0);
while(true){
if((i__22202 < size__5479__auto__)){
var vec__22207 = cljs.core._nth(c__5478__auto__,i__22202);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22203,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22311 = (i__22202 + (1));
i__22202 = G__22311;
continue;
} else {
var G__22312 = (i__22202 + (1));
i__22202 = G__22312;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22203),liquid_glass$tokens$tokens__GT_body_$_iter__22198_$_iter__22200(cljs.core.chunk_rest(s__22201__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22203),null);
}
} else {
var vec__22211 = cljs.core.first(s__22201__$2);
...
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22198_$_iter__22200(cljs.core.rest(s__22201__$2)));
} else {
var G__22313 = cljs.core.rest(s__22201__$2);
s__22201__$1 = G__22313;
continue;
}
}
} else {
...
});})(s__22199__$1,vec__22204,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22199__$1,vec__22204,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22198(cljs.core.rest(s__22199__$1)));
} else {
var G__22314 = cljs.core.rest(s__22199__$1);
s__22199__$1 = G__22314;
continue;
}
} else {
return null;
