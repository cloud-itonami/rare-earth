...
var h__$1 = (function (){var G__22767 = h;
if(clojure.string.starts_with_QMARK_(h,"#")){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__22767,(1));
} else {
return G__22767;
}
})();
 ...
 */
byoubu.color.rgb__GT_hex = (function byoubu$color$rgb__GT_hex(p__22770){
var vec__22771 = p__22770;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22771,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22771,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22771,(2),null);
...
var vec__22775 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22775,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22775,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22775,(2),null);
...
var pairs = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__22782){
var vec__22783 = p__22782;
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22783,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22783,(1),null);
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
...
if((total > (0))){
return byoubu.color.rgb__GT_hex((function (){var iter__5480__auto__ = (function byoubu$color$mix_$_iter__22786(s__22787){
...
var i = cljs.core._nth(c__5478__auto__,i__22788);
cljs.core.chunk_append(b__22789,(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__22788,i,c__5478__auto__,size__5479__auto__,b__22789,s__22787__$2,temp__5825__auto__,pairs,total){
return (function (p__22790){
var vec__22791 = p__22790;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22791,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22791,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i__22788,i,c__5478__auto__,size__5479__auto__,b__22789,s__22787__$2,temp__5825__auto__,pairs,total))
,pairs)) / total));

var G__22809 = (i__22788 + (1));
i__22788 = G__22809;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22789),byoubu$color$mix_$_iter__22786(cljs.core.chunk_rest(s__22787__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22789),null);
}
} else {
var i = cljs.core.first(s__22787__$2);
return cljs.core.cons((cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i,s__22787__$2,temp__5825__auto__,pairs,total){
return (function (p__22794){
var vec__22795 = p__22794;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22795,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22795,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i,s__22787__$2,temp__5825__auto__,pairs,total))
,pairs)) / total),byoubu$color$mix_$_iter__22786(cljs.core.rest(s__22787__$2)));
}
} else {
return null;
}
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22798 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22798,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22798,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22798,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22801 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22801,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22801,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22801,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
var mx = (function (){var x__5087__auto__ = (function (){var x__5087__auto__ = r__$1;
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22804 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22804,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22804,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22804,(2),null);
