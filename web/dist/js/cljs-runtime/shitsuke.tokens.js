...
var len__5726__auto___22145 = arguments.length;
var i__5727__auto___22146 = (0);
while(true){
if((i__5727__auto___22146 < len__5726__auto___22145)){
args__5732__auto__.push((arguments[i__5727__auto___22146]));

var G__22147 = (i__5727__auto___22146 + (1));
i__5727__auto___22146 = G__22147;
continue;
} else {
}
break;
...
/** @this {Function} */
(shitsuke.tokens.deep_merge.cljs$lang$applyTo = (function (seq22069){
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$pair__GT_css_$_iter__22070(s__22071){
return (new cljs.core.LazySeq(null,(function (){
var s__22071__$1 = s__22071;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22071__$1);
if(temp__5825__auto__){
var s__22071__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22071__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22071__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22073 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22072 = (0);
while(true){
if((i__22072 < size__5479__auto__)){
var vec__22074 = cljs.core._nth(c__5478__auto__,i__22072);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22074,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22074,(1),null);
cljs.core.chunk_append(b__22073,["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22159 = (i__22072 + (1));
i__22072 = G__22159;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22073),shitsuke$tokens$pair__GT_css_$_iter__22070(cljs.core.chunk_rest(s__22071__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22073),null);
}
} else {
var vec__22087 = cljs.core.first(s__22071__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22087,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22087,(1),null);
return cljs.core.cons(["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$tokens$pair__GT_css_$_iter__22070(cljs.core.rest(s__22071__$2)));
}
} else {
return null;
}
...
var body = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$iter__22100(s__22101){
return (new cljs.core.LazySeq(null,(function (){
var s__22101__$1 = s__22101;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22101__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__22106 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22106,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22106,(1),null);
var iterys__5476__auto__ = ((function (s__22101__$1,vec__22106,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function shitsuke$tokens$iter__22100_$_iter__22102(s__22103){
return (new cljs.core.LazySeq(null,((function (s__22101__$1,vec__22106,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__22103__$1 = s__22103;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22103__$1);
if(temp__5825__auto____$1){
var s__22103__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22103__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22103__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22105 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22104 = (0);
while(true){
if((i__22104 < size__5479__auto__)){
var vec__22109 = cljs.core._nth(c__5478__auto__,i__22104);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22109,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22109,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__22105,shitsuke.tokens.pair__GT_css(group,k,v));

var G__22164 = (i__22104 + (1));
i__22104 = G__22164;
continue;
} else {
var G__22165 = (i__22104 + (1));
i__22104 = G__22165;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22105),shitsuke$tokens$iter__22100_$_iter__22102(cljs.core.chunk_rest(s__22103__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22105),null);
}
} else {
var vec__22112 = cljs.core.first(s__22103__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.tokens.pair__GT_css(group,k,v),shitsuke$tokens$iter__22100_$_iter__22102(cljs.core.rest(s__22103__$2)));
} else {
var G__22166 = cljs.core.rest(s__22103__$2);
s__22103__$1 = G__22166;
continue;
}
}
} else {
...
});})(s__22101__$1,vec__22106,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__22101__$1,vec__22106,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,shitsuke$tokens$iter__22100(cljs.core.rest(s__22101__$1)));
} else {
var G__22167 = cljs.core.rest(s__22101__$1);
s__22101__$1 = G__22167;
continue;
}
} else {
return null;
...
var map__22118 = deck_design;
var map__22118__$1 = cljs.core.__destructure_map(map__22118);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22118__$1,new cljs.core.Keyword("slides","theme","slides/theme",-79736158));
var text_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22118__$1,new cljs.core.Keyword("slides","text-styles","slides/text-styles",-2082623934));
...
var color_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22123){
var vec__22124 = p__22123;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22124,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22124,(1),null);
...
var type_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22127){
var vec__22128 = p__22127;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22128,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22128,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,(function (){var G__22131 = cljs.core.PersistentArrayMap.EMPTY;
var G__22131__$1 = (cljs.core.truth_(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22131,new cljs.core.Keyword(null,"font-size","font-size",-1847940346),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts)),"px"].join('')):G__22131);
var G__22131__$2 = (cljs.core.truth_(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22131__$1,new cljs.core.Keyword(null,"color","color",1011675173),shitsuke.tokens.normalize_hex(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))):G__22131__$1);
if(cljs.core.truth_(new cljs.core.Keyword("slides","bold","slides/bold",-1297473049).cljs$core$IFn$_invoke$arity$1(ts))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22131__$2,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700));
} else {
return G__22131__$2;
}
})()], null);
})),text_styles);
var font_family = (function (){var or__5002__auto__ = (function (){var G__22135 = new cljs.core.Keyword("office-style.font","majorFont","office-style.font/majorFont",1886256746).cljs$core$IFn$_invoke$arity$1(fonts);
if((G__22135 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22135),", system-ui, sans-serif"].join('');
}
})();
...
var G__22136 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("shitsuke","colors","shitsuke/colors",-494612392),color_tokens], null);
if(cljs.core.seq(type_tokens)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22136,new cljs.core.Keyword("shitsuke","type","shitsuke/type",1602529816),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22137){
var vec__22138 = p__22137;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22138,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22138,(1),null);
