...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22929(s__22930){
return (new cljs.core.LazySeq(null,(function (){
var s__22930__$1 = s__22930;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22930__$1);
if(temp__5825__auto__){
var s__22930__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22930__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22930__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22932 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22931 = (0);
while(true){
if((i__22931 < size__5479__auto__)){
var vec__22941 = cljs.core._nth(c__5478__auto__,i__22931);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22941,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22941,(1),null);
cljs.core.chunk_append(b__22932,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__22985 = (i__22931 + (1));
i__22931 = G__22985;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22932),byoubu$facts$declared_content_color_$_iter__22929(cljs.core.chunk_rest(s__22930__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22932),null);
}
} else {
var vec__22947 = cljs.core.first(s__22930__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22947,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22947,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22929(cljs.core.rest(s__22930__$2)));
}
} else {
return null;
}
...
var G__22950 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22950__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22950,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22950);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22950__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22950__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22961){
var vec__22962 = p__22961;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(1),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22962,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22965){
var vec__22966 = p__22965;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22966,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22966,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22951_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22951_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22970 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22970,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22970,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22970,(2),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22976),byoubu$facts$derive_facts_$_iter__22973(cljs.core.chunk_rest(s__22974__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22976),null);
}
} else {
var vec__22980 = cljs.core.first(s__22974__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22980,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22980,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22973(cljs.core.rest(s__22974__$2)));
}
} else {
return null;
}
