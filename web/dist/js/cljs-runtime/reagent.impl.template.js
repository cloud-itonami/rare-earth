...
var temp__5827__auto__ = reagent.impl.template.cache_get(reagent.impl.template.prop_name_cache,cljs.core.name(k));
...
var G__22543 = o;
reagent.impl.template.goog$module$goog$object.set(G__22543,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
G__22640.cljs$lang$applyTo = (function (arglist__22646){
...
if(reagent.impl.util.named_QMARK_(k)){
var temp__5827__auto__ = reagent.impl.template.cache_get(reagent.impl.template.custom_prop_name_cache,cljs.core.name(k));
if((temp__5827__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
...
var G__22546 = o;
reagent.impl.template.goog$module$goog$object.set(G__22546,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22691__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22691 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22692__i = 0, G__22692__a = new Array(arguments.length -  0);
while (G__22692__i < G__22692__a.length) {G__22692__a[G__22692__i] = arguments[G__22692__i + 0]; ++G__22692__i;}
  args = new cljs.core.IndexedSeq(G__22692__a,0,null);
} 
return G__22691__delegate.call(this,args);};
G__22691.cljs$lang$maxFixedArity = 0;
G__22691.cljs$lang$applyTo = (function (arglist__22697){
var args = cljs.core.seq(arglist__22697);
return G__22691__delegate(args);
});
...
var G__22551 = props;
var G__22551__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22551,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22551);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22551__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22555 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22555,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22555;
}
})(),id_class);
...
var G__22559 = (cljs.core.count(argv) - first_child);
switch (G__22559) {
case (0):
...
var vec__22562 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(2),null);
...
var temp__5829__auto___22699 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22699 == null)){
} else {
var key_22700 = temp__5829__auto___22699;
(jsprops.key = key_22700);
}
...
var temp__5829__auto___22701 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22701 == null)){
} else {
var key_22702 = temp__5829__auto___22701;
(jsprops.key = key_22702);
}
...
var temp__5829__auto___22703 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22703 == null)){
} else {
var key_22704 = temp__5829__auto___22703;
(jsprops.key = key_22704);
}
...
var temp__5827__auto__ = reagent.impl.template.cache_get(reagent.impl.template.tag_name_cache,x);
if((temp__5827__auto__ == null)){
...
var temp__5829__auto___22705 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22705 == null)){
} else {
var key_22706 = temp__5829__auto___22705;
(jsprops.key = key_22706);
}
...
var temp__5829__auto___22707 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22707 == null)){
} else {
var key_22708 = temp__5829__auto___22707;
(jsprops.key = key_22708);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22574_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22574_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22576 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22576,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22576,(1),null);
...
var G__22580 = tag;
var G__22580__$1 = (((G__22580 instanceof cljs.core.Keyword))?G__22580.fqn:null);
switch (G__22580__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template22582 = (function (opts,id,fn_to_element,parse_fn,meta22583){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22582.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22584,meta22583__$1){
var self__ = this;
var _22584__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22582(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22583__$1));
}));

(reagent.impl.template.t_reagent$impl$template22582.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22584){
var self__ = this;
var _22584__$1 = this;
return self__.meta22583;
}));

(reagent.impl.template.t_reagent$impl$template22582.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22582.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22582.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22582.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22582.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22582.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22583","meta22583",2049475102,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22582.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22582.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22582");

(reagent.impl.template.t_reagent$impl$template22582.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22582");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22582.
 */
reagent.impl.template.__GT_t_reagent$impl$template22582 = (function reagent$impl$template$__GT_t_reagent$impl$template22582(opts,id,fn_to_element,parse_fn,meta22583){
return (new reagent.impl.template.t_reagent$impl$template22582(opts,id,fn_to_element,parse_fn,meta22583));
});
...
return (new reagent.impl.template.t_reagent$impl$template22582(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
