...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,(function (){var G__21921 = cljs.core.PersistentArrayMap.EMPTY;
var G__21921__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21921,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes)):G__21921);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21921__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__21921__$1;
}
})()], null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("",cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21924){
var vec__21926 = p__21924;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21926,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21926,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__21929){
...
var vec__21940 = html.core.parse_tag(cljs.core.first(x));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21940,(0),null);
...
var vec__21953 = node;
var seq__21954 = cljs.core.seq(vec__21953);
var first__21955 = cljs.core.first(seq__21954);
var seq__21954__$1 = cljs.core.next(seq__21954);
var t = first__21955;
var body = seq__21954__$1;
var vec__21956 = html.core.parse_tag(t);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21956,(0),null);
var base = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21956,(1),null);
var vec__21959 = ((cljs.core.map_QMARK_(cljs.core.first(body)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.rest(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body], null));
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21959,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21959,(1),null);
...
var len__5726__auto___22034 = arguments.length;
var i__5727__auto___22035 = (0);
while(true){
if((i__5727__auto___22035 < len__5726__auto___22034)){
args__5732__auto__.push((arguments[i__5727__auto___22035]));

var G__22036 = (i__5727__auto___22035 + (1));
i__5727__auto___22035 = G__22036;
continue;
} else {
}
break;
...
/** @this {Function} */
(html.core.html.cljs$lang$applyTo = (function (seq21971){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21971));
}));
...
var G__22041 = (i__5727__auto___22040 + (1));
i__5727__auto___22040 = G__22041;
continue;
} else {
}
break;
...
/** @this {Function} */
(html.core.html5.cljs$lang$applyTo = (function (seq21978){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21978));
}));
